...
// Do the same thing as 7th question, but use a template string and interpolation. 
console.log(`Total cost: $${cof+bag}`);

// Display the text from 8th question in a popup. 
//alert("Total cost: $",cof+bag);

// Using a multi-line string, create the text from 8th question and add a line of text underneath: 'Thank You, come again!'. Display both lines in a popup. 
